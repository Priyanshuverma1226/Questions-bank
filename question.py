    ...
    def update(self, cursor, bboxs):
        ...
        for x, bbox in enumerate(bboxs):
            ...
            if x1 < cursor[0] < x2 and y1 < cursor[1] < y2:
                self.userAns = x + 1
                cv2.rectangle(img, (x1, y1), (x2, y2), (124,252,0), cv2.FILLED)


# Import csv file data
pathCSV = "question.csv"
...
while True:
    ...
    cv2.rectangle(img, (150, 600), (barValue, 650), (124,252,0), cv2.FILLED)
    cv2.rectangle(img, (150, 600), (1100, 650), (124,252,0), 5)
